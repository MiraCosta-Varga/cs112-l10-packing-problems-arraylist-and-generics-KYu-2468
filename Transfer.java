...
public class Transfer {
  ...
  public void addItems(int listNumber) {
    ...
    if (listNumber == 1) {// Add to Food list
       ...
       */
      System.out.println(foodList.add(newFoodItem));
       ...
       * Print to make sure it was successful
       */
      System.out.println(partsList.add(newPartsItem));
       ...
       * Print to make sure it was successful
       */
      System.out.println(suppliesList.add(newSuppliesItem));
   ...
   * Food/Parts/Supplies
   */
  Inventory<Food> foodInventory = new Inventory<>(foodList);
  Inventory<Parts> partsInventory = new Inventory<>(partsList);
  Inventory<Supplies> suppliesInventory = new Inventory<>(suppliesList);
  ...
  public void printLists() {
    ...
    if (!foodList.isEmpty()) {
      ...
      for (int i = 0; i < foodList.size(); i++) {
        ...
        System.out.printf("\n%-25.25s %-15.15s %-10.10s", tempFood.getName(), tempFood.getPerishable(),
    ...
    if (!partsList.isEmpty()) {
      ...
      for (int i = 0; i < partsList.size(); i++) {
        ...
        System.out.printf("\n%-25.25s %-15.15s %-10.10s", tempPart.getName(), "" + tempPart.getPartNumber(),
